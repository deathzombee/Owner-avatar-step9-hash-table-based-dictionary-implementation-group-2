...
class TestInventorySLDict(unittest.TestCase):
    def setUp(self):
        # Initialize the inventory system
        self.inventory = SatSystemSLDict()
        # Manually populate the inventory with test data
        self.inventory.satdict = SLDict()
        self.sat1 = Satellite(
            name="Hubble",
            orbit_type="LEO",
            orbit_height="569",
    ...
    def test_add_satellite(self, mock_input, mock_print):
        ...
        # test if mock_input is called for each attribute
...
"""
    ...
    def test_write_back_no_satellites(self):
        # Clear the inventory by assigning a new empty SLDict
        self.inventory.satdict = SLDict()
